...
Разархивируйте и откройте проект HS_316_py.7z в MasterSCADA 4D и убедитесь, что настройки подключения к OPC UA серверу соответствуют указанному выше адресу.
